...
reason, the utreexod suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire utreexod
...
One of the major design goals of all core utreexod packages is to aim for complete
...
commits](https://github.com/utreexo/utreexod/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into utreexod.
...
Rejoice as you will now be listed as a [contributor](https://github.com/utreexo/utreexod/graphs/contributors)!
...
[ISC license](https://github.com/utreexo/utreexod/blob/master/LICENSE).  This is
the same license as all of the code in the utreexod suite.
