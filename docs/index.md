...
utreexod is an alternative full node bitcoin implementation written in Go (golang).
...
taken great care to avoid utreexod causing a fork to the block chain.  It includes a
...
One key difference between utreexod and Bitcoin Core is that utreexod does *NOT* include
wallet functionality and this was a very intentional design decision.  See the
blog entry [here](https://web.archive.org/web/20171125143919/https://blog.conformal.com/btcd-not-your-moms-bitcoin-daemon)
for more details.  This means you can't actually make or receive payments
directly with utreexod.  That functionality is provided by the
...
Documentation is a work-in-progress. It is available at [utreexod.readthedocs.io](https://utreexod.readthedocs.io).
